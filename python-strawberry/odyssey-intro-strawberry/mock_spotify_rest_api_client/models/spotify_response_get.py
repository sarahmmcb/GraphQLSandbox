...
class SpotifyResponseGET:
    ...
    Attributes:
        ...
        authorize (SpotifyResponseGETAuthorizeType0 | SpotifyResponseGETAuthorizeType1):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.spotify_object_current_user import (
        ...
        from ..models.spotify_object_new_releases import (
        ...
        from ..models.spotify_object_playback_queue import (
            SpotifyObjectPlaybackQueue,
        )
        from ..models.spotify_object_playback_state import (
            SpotifyObjectPlaybackState,
        )
        from ..models.spotify_object_playlist import (
            SpotifyObjectPlaylist,
        )
        from ..models.spotify_object_recommendations import (
            SpotifyObjectRecommendations,
        )
        from ..models.spotify_object_search_results import (
